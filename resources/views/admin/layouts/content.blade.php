                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body chat-box scrollable" style="height:300px;">
                                        <ul class="chat-list">
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{asset('template/plugins/img/users/1.jpg')}}" alt="user"></div>
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{asset('template/plugins/img/users/2.jpg')}}" alt="user"></div>
                                                <div class="chat-content">
                                            ...
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{asset('template/plugins/img/users/3.jpg')}}" alt="user"></div>
                                                <div class="chat-content">
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    ...
                                    <div class="card-body timeline">
                                        <div class="header bg-theme" style="background-image: url('{{asset('template/plugins/img/placeholder/placeimg_400_200_nature.jpg')}}">
