                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                                    ...
                                    <div class="notifications-wrap">
                                        ...
                                        <a href="#" class="media">
                                            <span class="d-flex">
                                                <img src="{{asset('template/plugins/img/users/1.jpg')}}" class="rounded-circle" alt="">
                                            </span>
                                            <span class="media-body">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar" src="{{asset('template/plugins/img/user.jpg')}}"alt=""></a>
