                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Copyright © AllowAid.</span>
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Talk to us, <a href="http://lavalite.org/" class="text-dark" target="_blank">We can help</a></span>
                    </div>
                </footer>
